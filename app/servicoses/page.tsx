...
/* =======================================
   LISTA DE SERVICIOS (MISMA DE LA HOME)
   ======================================= */
const services = [
  {
    ...
    description:
      "Ensayos estáticos y dinámicos con emisión de certificados e informes conforme a los requisitos de sociedades clasificadoras y normas vigentes.",
  ...
  },
  {
    ...
    description:
      "Inspecciones, mantenimiento y reparaciones en botes, cabrestantes, pescantes y equipos de salvamento, garantizando disponibilidad y seguridad.",
  ...
  },
  {
    ...
    description:
      "Inspecciones técnicas, informes detallados y soporte de ingeniería aplicada a la integridad de activos offshore y onshore.",
...
const nrSteps = [
  {
    nr: "NR 10",
    label: "Seguridad",
    title: "Servicios con Electricidad.",
    description:
      "Establece procedimientos y requisitos de seguridad para evitar descargas eléctricas, cortocircuitos e incendios.",
  },
  {
    nr: "NR 11",
    label: "Manipulación de Materiales",
    title: "Transporte, Movimiento y Almacenamiento.",
    description:
      "Establece requisitos de seguridad para el transporte, movimiento y almacenamiento de materiales, como cargas pesadas o voluminosas.",
  },
  {
    nr: "NR 12",
    label: "Seguridad",
    title: "Trabajo con Máquinas y Equipos.",
    description:
      "Medidas preventivas de seguridad en el uso de máquinas y equipos, garantizando la protección de los trabajadores contra accidentes.",
  },
  {
    nr: "NR 13",
    label: "Seguridad",
    title: "Calderas, Recipientes a Presión y Tuberías",
    description:
      "Operación de calderas, recipientes a presión y tuberías, equipos esenciales en diversos sectores industriales.",
  },
];
...
export default function ServicesPage() {
  ...
  /* =======================================
     EFECTO DE RESALTAR EN EL SCROLL (AZUL)
     ======================================= */
  useEffect(() => {
    const handleScroll = () => {
  ...
  return (
    <>
      ...
      <section className="relative w-full min-h-[60vh] overflow-hidden bg-slate-900">
        ...
        >
          ...
          <p className="text-base md:text-lg text-slate-100 max-w-2xl">
            ...
            equipos especializados y enfoque absoluto en seguridad, cumplimiento
      ...
      <main className="max-w-6xl mx-auto px-4 py-16 space-y-20">
        {/* =======================================
            GRID PRINCIPALES SERVICIOS
           ======================================= */}
        <section className="space-y-4">
          {/* título – tamaño de fuente: text-2xl / md:text-3xl */}
          ...
          {/* GRID DE CARDS – mismo estilo de la home */}
          <div className="grid md:grid-cols-3 gap-6">
            {services.map((s) => (
              <Link
                key={s.slug}
                href={`/servicoses/${s.slug}`}
        ...
        <section className="py-10 md:py-20">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-semibold text-[#1c2743]">
              Servicio: Certificación de NRs
            </h2>
            <p className="text-sm md:text-base text-slate-500 mt-2">
              Top 4 NRs esenciales para la seguridad laboral
            </p>
          </div>
